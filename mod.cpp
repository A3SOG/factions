...
tooltipOwned    = "Special Operations Group";  // Tool tip displayed when the mouse is left over, in the main menu
overview        = "Special Operations Group Official Factions";         // Overview text, displayed from the extension menu
